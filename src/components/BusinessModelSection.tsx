          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                <h4 className="font-bold text-green-700 mb-2">✅ גישה לכל החיים ל-oFair לצרכנים:</h4>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                <h4 className="font-bold text-blue-700 mb-2">🚀 גישה לפלטפורמת שיתוף הלידים הראשונה בעולם:</h4>
                <ul className="text-gray-600 space-y-1 mr-4">
