      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="feature-card scroll-fade">
            ...
            <h3 className="text-xl font-bold mb-3 text-ofair-900">צרכנים שולחים פניות מדויקות</h3>
            <p className="text-muted-foreground">קבלו פניות מדוייקות מצרכנים - כל הפרטים כדי שתוכלו להציע מחיר/זמינות - ולהבין אם *באמת* הלקוח רלוונטי לכם !</p>
          </div>
          ...
          transitionDelay: "300ms"
            ...
            <h3 className="text-xl font-bold mb-3 text-ofair-900">לוח מודעות חכם</h3>
