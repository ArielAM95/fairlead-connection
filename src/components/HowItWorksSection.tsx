...
const HowItWorksSection = () => {
  ...
  const steps = [
    ...
    {
      number: "2️⃣",
      title: "מתחילים לקבל ולהעביר לידים",
      description: "מצאו עבודות שמתאימות לכם ושתפו לידים שאתם לא יכולים לבצע."
    },
    {
      number: "3️⃣",
      title: "מתמקדים במה שחשוב באמת",
      description: "פחות טלפונים מיותרים, יותר עסקאות סגורות!"
    }
  ];
