      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-4">
            <a href="#" className="flex items-center space-x-2 space-x-reverse mb-4">
              <span className="text-2xl font-bold text-ofair-900">oFair</span>
            </a>
            <p className="text-gray-600">🔹 oFair – מהפכת שיתוף הלידים והעבודה החכמה כבר כאן!</p>
            <p className="text-gray-500 mt-4 text-sm">הפלטפורמה שתחבר בין בעלי מקצוע, מאפשרת שיתוף לידים ומציגה הצעות מחיר בזמן אמת</p>
          </div>
          
          {/* Navigation Links */}
          <div className="md:col-span-4">
            <h3 className="font-semibold text-ofair-900 mb-4">ניווט מהיר</h3>
          ...
          {/* Contact */}
          <div className="md:col-span-4">
            <h3 className="font-semibold text-ofair-900 mb-4">צור קשר</h3>
            <div className="space-y-3">
              <p className="text-gray-600 flex">
                ...
                <a href="mailto:info@ofair.co.il" className="hover:text-ofair-900 transition-colors">info@ofair.co.il</a>
              </p>
              <p className="text-gray-600 flex">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 ml-2 text-ofair-900">
