...
const AppShowcaseSection = () => {
  ...
  const appAltText = useTranslatedText("אפליקציית OFAIR");
        ...
        <div className="scroll-fade opacity-0 translate-y-10 transition-all duration-700">
          <div className="bg-white/95 backdrop-blur-sm rounded-3xl p-8 md:p-12 shadow-2xl">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-blue-900 mb-6 leading-tight">
              <T>אפליקציה אמיתית. נוחה. שמכניסה לך כסף.</T>
            </h2>

            {/* Subtext */}
            <p className="text-lg md:text-xl text-blue-800/90 leading-relaxed mb-8">
              <T>האפליקציה של OFAIR לא רק מציגה לכם את הלידים הנכנסים - היא מאפשרת לכם להפוך לידים לא מנוצלים להכנסה נוספת, להרחיב את הקהילה המקצועית שלכם, ולבנות זרם הכנסה נוסף מהידע והניסיון שלכם. בנוסף, תקבלו התראות WhatsApp אוטומטיות על לידים רלוונטיים לכם – עם כל הפרטים המלאים וקישור ישיר למודעה באפליקציה, כך שלא תפספסו אף הזדמנות. כל זה בממשק פשוט ואינטואיטיבי שעובד בדיוק כמו שאתם צריכים.</T>
            </p>
