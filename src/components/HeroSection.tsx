...
const HeroSection = () => {
  ...
  return <div className="min-h-screen flex items-center relative overflow-hidden">
      ...
      {/* Content Overlay */}
      <div className="container mx-auto px-4 md:px-6 py-20 z-10 relative bg-slate-900">
        <div className="max-w-6xl mx-auto">
          <div ref={elementRef} className="staggered-animation text-right">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-8">
              <Button className="bg-primary hover:bg-primary/90 text-white px-10 py-6 text-lg button-pulse shadow-xl" onClick={scrollToForm}>
