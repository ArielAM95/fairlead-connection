            ...
            <div ref={elementRef} className="staggered-animation">
              ...
              <div className="mobile-hero-item">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mt-16">
                  ...
                  <div className="text-center transform hover:scale-105 transition-transform duration-300">
                    <h3 className="text-2xl font-bold text-white mb-2 drop-shadow-lg">👥 חבר מביא חבר</h3>
                    <p className="text-white/90 text-lg drop-shadow-md">
                      הזמינו חברים והרוויחו 10% קרדיט, גם המופנה מקבל 10% הנחה!
                    </p>
                  </div>
          ...
          <div className="hidden lg:grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="relative">
                <img src="/lovable-uploads/ofair-character.png" alt="oFair Character" className="w-80 h-auto object-contain drop-shadow-2xl animate-float" />
